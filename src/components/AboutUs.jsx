...
const AboutUs = () => {
  return (
    <div className="py-20 flex items-center w-[85%] mx-auto gap-20">
      <img src={about} className="w-[40vw]" alt="" />
      <div>
        <h3>About Us</h3>
        <h2 className="text-[50px] font-bold leading-[60px]">
          We Always Make <br /> The Best
        </h2>
        <hr className="my-4 w-[100px] border-2 border-red-500" />
        <p className=" text-[17px] w-[35vw] mx-auto text-[#8F8F8F]">
